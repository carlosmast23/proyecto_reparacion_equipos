<div class="container" data-aos="fade-up">
    <form action="<?= base_url() ?>index.php/admin/gestionarUsuarioGrabar" method="post" role="form">
        ...
        <div class="row" data-aos="fade-up" style="margin-top: 15px;" data-aos-delay="100">
            <div class="col-lg-4 offset-lg-4">
                <input type="text" name="apellidos" value="<?php echo $dato['apellidos'] ?>" class="form-control" placeholder="Apellidos" required>
            </div>
        </div>

        <div class="row" data-aos="fade-up" style="margin-top: 15px;" data-aos-delay="100">
            <div class="col-lg-4 offset-lg-4">
                <input type="text" name="nombres" value="<?php echo $dato['nombres'] ?>" class="form-control" placeholder="Nombres" required>
            </div>
        </div>
